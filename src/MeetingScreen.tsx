          ...
          <div className="settings-section">
            ...
            <div className="key-group">
              ...
              <input className="form-input" type="password" placeholder="sk-proj-…"
                value={openaiKey} onChange={e => setOpenaiKey(e.target.value)} autoComplete="off" spellCheck={false} />
            </div>
            <div className="key-group">
              ...
              <input className="form-input" type="password" placeholder="Paste your Deepgram API key"
                value={deepgramKey} onChange={e => setDeepgramKey(e.target.value)} autoComplete="off" spellCheck={false} />
            </div>
